...
const SkillPill = ({ name, icon }) => (
  <div className="group flex items-center gap-2 px-3 py-2 border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.18] transition-all duration-300 cursor-default rounded-sm hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgb(240_237_230_/_0.04)]">
    <img
      src={icon}
      alt={`${name} icon`}
      className="w-4 h-4 object-contain opacity-80 transition-transform duration-300 group-hover:scale-110"
    />
