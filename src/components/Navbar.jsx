  ...
  return (
    <nav className="fixed top-0 w-full bg-[#a9a9a9] text-white flex items-center justify-between px-8 py-4">
      ...
      <section className="flex gap-3">
        <a onClick={() => goToPage("/home")} className="cursor-pointer">Home</a>
        <a onClick={() => goToPage("/contact")} className="cursor-pointer">Contact</a>
        <a onClick={() => goToPage("/about")} className="cursor-pointer">About</a>
      </section>
